...
export default function HeroCarousel() {
  ...
  return (
    <section id="home" className="hero relative min-h-[930px] h-[100svh] overflow-hidden bg-[#222] max-[900px]:min-h-[820px] max-[720px]:min-h-[680px] max-[430px]:min-h-[620px]" aria-label="Harmony Med Spa image carousel">
      ...
      <div className="hero-content absolute z-[2] left-[50%] bottom-[54px] [transform:translateX(-50%)] w-[min(1080px,94vw)] text-[#fff] text-center max-[720px]:bottom-[42px] [&_h1]:mt-0 [&_h1]:mb-[34px] [&_h1]:mx-0 [&_h1]:[font-family:'Segoe_UI_Light','Helvetica_Neue',Arial,sans-serif] [&_h1]:text-[length:clamp(76px,8.2vw,128px)] [&_h1]:leading-[0.95] [&_h1]:font-extralight [&_h1]:tracking-[0] [&_h1]:min-h-[0.95em] max-[720px]:[&_h1]:mb-[28px] max-[720px]:[&_h1]:text-[length:clamp(46px,12vw,64px)] max-[430px]:[&_h1]:text-[length:clamp(38px,11vw,52px)]">
        <h1>
