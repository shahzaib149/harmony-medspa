  ...
  return (
    <main className="service-detail-page min-h-[100vh] bg-[#fff]">
      ...
      <section className="service-detail-content min-h-[560px] pt-[94px] pb-[136px] px-[24px] max-[720px]:pt-[72px] max-[720px]:pb-[92px] max-[720px]:px-[20px]">
        ...
        <div className="treatment-card-grid treatment-card-grid-four grid justify-center gap-[16px] grid-cols-[repeat(4,244px)] gap-y-[30px] gap-x-[16px] mt-[50px] max-[720px]:grid-cols-[minmax(244px,320px)] max-[720px]:gap-[22px]">
